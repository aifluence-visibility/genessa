  ...
  return (
    <div style={{ padding: "36px 40px 80px", color: "#111827" }}>
      ...
      <PlanGate
        ...
        featureDescription="Generate branded PDF reports for your AI visibility scans. Share with clients or stakeholders. Available on Pro and above."
      >
        <div style={{
          ...
          <p style={{ fontSize: 14, color: "#6B7280", maxWidth: 360, margin: "0 auto" }}>
            Download branded PDF reports from your scan history. Currently available from the Dashboard Overview.
          </p>
        </div>
      </PlanGate>
    </div>
