    ...
    <div style={{ padding: "36px 40px 80px", color: "#111827" }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "#6B7280", margin: 0 }}>
          AI mention tracking and citation analysis.
        </p>
      </div>
      <PlanGate
        requiredPlan="pro"
        currentPlan={plan}
        featureName="AI Influence"
        featureDescription="Track how often AI models mention your brand, monitor citations, and analyze your influence signals. Available on Pro and above."
      >
        <div style={{
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, color: "#111827", margin: "0 0 8px" }}>
            AI Influence detail — coming soon
          </h2>
          <p style={{ fontSize: 14, color: "#6B7280", maxWidth: 360, margin: "0 auto" }}>
            AI mention tracking, citation analysis, and influence score breakdown.
          </p>
        </div>
      </PlanGate>
    </div>
